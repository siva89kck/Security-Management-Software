                ...
                <div class="row g-3">
                    <div class="col-md-3">
                        <div class="detail-card">
                            ...
                            <input type="date" name="issue_date" value="{{ old('issue_date', $issue->issue_date) }}" class="form-control" required>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="detail-card">
                        ...
                        <div class="detail-card">
                            ...
                            <select name="employee_id" class="form-select" required>
                                ...
                                @foreach ($employees as $id => $name)
                                    <option value="{{ $id }}" @selected(old('employee_id', $issue->employee_id)==$id)>{{ $name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="detail-card">
                            ...
                            <input type="text" name="remarks" value="{{ old('remarks', $issue->remarks) }}" class="form-control">
                        </div>
                    </div>
                </div>
