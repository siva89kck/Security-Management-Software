                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <div class="detail-card">
                                ...
                                <input type="text" name="size" class="form-control" value="{{ old('size', $master->size) }}" required>
                        ...
                        <div class="col-md-6">
                            <div class="detail-card">
                                ...
                                <input type="number" step="0.01" name="price" class="form-control" value="{{ old('price', $master->price) }}" required>
