                                ...
                                <div class="tab-pane fade show active" id="tab-personal" role="tabpanel">
                                    <div class="row">
                                        <div class="col-12 mb-3">
                                            <label class="form-label f-w-500">Name <span class="text-danger">*</span></label>
                                ...
                                <div class="tab-pane fade" id="tab-contact" role="tabpanel">
                                    <div class="row">
                                        ...
                                        <div class="col-12 mb-3">
                                            ...
                                            <input type="file" name="pan_card" class="form-control @error('pan_card') is-invalid @enderror"
                                                   accept=".pdf,.jpg,.jpeg,.png,.doc,.docx">
                                            @if ($employee->pan_card)
                                                <small class="d-block mt-1">Current:
                                                    <a href="{{ asset('storage/' . $employee->pan_card) }}" target="_blank">View File</a>
                                                </small>
                                            @endif
                                        ...
                                        <div class="col-12 mb-3">
                                            ...
                                            <input type="file" name="address_proof" class="form-control @error('address_proof') is-invalid @enderror"
                                                   accept=".pdf,.jpg,.jpeg,.png,.doc,.docx">
                                            @if ($employee->address_proof)
                                                <small class="d-block mt-1">Current:
                                                    <a href="{{ asset('storage/' . $employee->address_proof) }}" target="_blank">View File</a>
                                                </small>
                                            @endif
                                        ...
                                        <div class="col-12 mb-3">
                                            ...
                                            <input type="file" name="photo" class="form-control @error('photo') is-invalid @enderror"
                                                   accept=".jpg,.jpeg,.png,.gif" onchange="validateFileSize(this)">
                                            @if ($employee->photo)
                                                <small class="d-block mt-1">Current:
