...
<style>
    ...
    <div class="row m-1">
        <div class="col-12">
            <h4 class="main-title">Edit Employee</h4>
            <ul class="app-line-breadcrumbs mb-3">
                ...
                <li class="active">
                    <a href="#" class="f-s-14 f-w-500">Edit Employee</a>
                </li>
            </ul>
        </div>
    </div>
                                ...
                                <div class="col-xl-9">
                                    <div class="tab-content" id="employeeWizardContent">
                                        <div class="tab-pane fade show active" id="tab-personal">
                                            @include('employees.parts._personal', ['employee' => $employee])
                                        </div>
                                        <div class="tab-pane fade" id="tab-official">
                                            @include('employees.parts._official', ['employee' => $employee])
                                        </div>
                                        <div class="tab-pane fade" id="tab-address">
                                            @include('employees.parts._address', ['employee' => $employee])
                                        </div>
                                        <div class="tab-pane fade" id="tab-languages">
                                            @include('employees.parts._languages', ['employee' => $employee])
                                        </div>
                                        <div class="tab-pane fade" id="tab-family">
                                            @include('employees.parts._family', ['employee' => $employee])
                                        </div>
                                        <div class="tab-pane fade" id="tab-experiences">
                                            @include('employees.parts._experiences', ['employee' => $employee])
                                        </div>
                                        <div class="tab-pane fade" id="tab-payroll">
                                            @include('employees.parts._payroll', ['employee' => $employee])
                                        </div>
                                        <div class="tab-pane fade" id="tab-banks">
                                            @include('employees.parts._banks', ['employee' => $employee])
                                        </div>
                                        <div class="tab-pane fade" id="tab-enclosures">
                                            @include('employees.parts._enclosures', ['employee' => $employee])
                                        </div>
                                    </div>
