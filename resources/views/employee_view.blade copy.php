                        ...
                        <div class="col-md-6">
                            <p><strong>PAN Card:</strong>
                                @if($employee->pan_card)
                                    <a href="{{ Storage::url($employee->pan_card) }}" target="_blank" class="btn btn-sm btn-outline-primary">View</a>
                                @else
                                    Not Uploaded
                                @endif
                            </p>
                        ...
                        <div class="col-md-6">
                            <p><strong>Address Proof:</strong>
                                @if($employee->address_proof)
                                    <a href="{{ Storage::url($employee->address_proof) }}" target="_blank" class="btn btn-sm btn-outline-primary">View</a>
                                @else
                                    Not Uploaded
                                @endif
                            </p>
